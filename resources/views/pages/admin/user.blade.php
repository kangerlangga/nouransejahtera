            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs">
                        <a href="{{ route('user.add') }}" class="btn btn-round text-white ml-auto fw-bold" style="background-color: #BD181C">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-header" style="background-color: #BD181C">
                                <div class="profile-picture">
                                    <div class="avatar avatar-xl">
                                        <img src="{{  url('') }}/assets/admin/img/user.png" alt="{{ $U->name }}" class="avatar-img rounded-circle" style="background-color: white">
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
